...
class DataModuleFromConfig(pl.LightningDataModule):
    def __init__(self, batch_size, train=None, validation=None, test=None, predict=None,
                 ...
                 shuffle_val_dataloader=False, cache_dir=None, cache_name=None):
        super().__init__()
...
if __name__ == "__main__":
    ...
    try:
        ...
        data.prepare_data()
        data.setup()
        # print("2222222222222",type(data.train_dataloader))
        ...
        # run
        #print(opt.no_test, trainer.interrupted, opt.train)
        if opt.train:
            try:
